...
public class TweetsAdapter extends ArrayAdapter<Tweet> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Date timestamp = Tweet.parseDate(tweet.getTimestamp());
		CharSequence timeSince = DateUtils.getRelativeDateTimeString(getContext(), timestamp.getTime(), DateUtils.SECOND_IN_MILLIS, DateUtils.DAY_IN_MILLIS, DateUtils.FORMAT_NO_NOON);
		timestampView.setText(timeSince);
		return view;
	}
